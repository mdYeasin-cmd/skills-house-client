...
type InstructorsInfoType = IInstructorInfo[];

const Instructor = () => {

    const instructorsInfo: InstructorsInfoType = [
        {
            name: "Nahiyan Siddik",
            designation: "Full Stack Web Developer",
            instructorImg: instructor1,
            about: "6+ years experiences in Full Web Development Sector and Trained over 3500+ students"
        },
        {
            name: "Forkan Uddin",
            designation: "Professional Graphic Designer",
            instructorImg: instructor2,
            about: "5+ years experiences in Professional Graphic Desiging Sector and Trained over 3000+ students"
        },
        {
            name: "Rakib Ahmed",
            designation: "Full Stack Digital Marketer",
            instructorImg: instructor3,
            about: "4+ years experiences in Full Stack Digital Marketing Sector and Trained over 3000+ students"
        },
    ]
                            ...
                            <div className="">
                                <div className="flex flex-wrap justify-center">
                                    <div className="flex justify-center w-full">
                                        <div>
                                            <img src={instructorInfo.instructorImg} alt="" className="w-[150px] h-[150px] rounded-full instructor-picture border-white" />
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-3 text-center">
                                    <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">{instructorInfo.name}</h3>
                                    <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                                        ...
                                        <div className="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono ">{instructorInfo.designation}</div>
                                    ...
                                    <div className="w-full text-center">
                                        <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                                            <div className="flex space-x-2">
                                                <Link
                                                    className="p-1 -m-1 text-gray-500 hover:text-[#51DBDC] focus:outline-none focus-visible:ring-2 ring-primary"
                                                    to="/"
                                                    rel="noopener"
                                                ...
                                                <Link className="p-1 -m-1 text-gray-500 hover:text-[#51DBDC] focus:outline-none focus-visible:ring-2 ring-primary" to="/" rel="noopener" aria-label="Ariel Cerda on Github">

...
const Instructor = () => {
    return (
        <div className='flex items-center justify-center min-h-[510px] bg-base-200'>
            <div className="relative w-9/12 mx-auto mt-6 mb-6 bg-white border dark:bg-gray-800 dark:border-gray-700 rounded-xl">
                <div className="pb-6">
                    <div className="flex flex-wrap justify-center">
                        <div className="flex justify-center w-full">
                            <div className="relative">
                                <img src="https://source.unsplash.com/jmURdhtm7Ng/120x120" className="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="mt-2 mt-20 text-center">
                        ...
                        <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                            ...
                            <div className="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">Diseñador UI / Front-end</div>
                        ...
                        <div className="w-full text-center">
                            <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                                <div className="flex space-x-2">
                                    ...
                                    <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" href="https://www.github.com/Smilesharks" rel="noopener" aria-label="Ariel Cerda on Github" target="_blank">

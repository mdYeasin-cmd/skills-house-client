...
const SignUp = () => {
  const { setUser, providerLogIn, signUp } = useContext(
    AuthContext
  ) as AuthContextType;
            ...
            <div className="bg-white shadow-xl rounded px-8 pt-6 pb-7 mb-4 border">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                <div className="mb-6 user-email">
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    <div className="flex items-center border-b border-gray-400 pl-0 pt-2 pb-1">
                      <input
                        {...register("email")}
                        className="appearance-none bg-transparent border-none w-full text-[#34526e] mr-3 py-1 px-2 leading-tight focus:outline-none text-base"
                        type="text"
                        placeholder="Email"
                        name="email"
                      />
                  ...
                  <div className="mt-1 flex items-center ">
                    ...
                    <div className="w-4/5 flex items-center">
                      ...
                      <input
                        ...
                        className="w-full rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4 text-center signup-button">
                  <button
                    className="transition duration-500 bg-[#34526e] login-btn-hover text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline uppercase"
                    type="submit"
                  >
                    Sign Up
                  </button>
              ...
              <div className="mt-5 already-account">
                <p className="text-sm text-center">
                  ...
                  <Link
                    className="font-bold text-sm text-[#51DBDC] color-effect hover:text-orange-800 ml-1"
                    to="/login"
                  >
                    Log In
                  </Link>
              ...
              <button
                onClick={googleLogIn}
                className="w-9 h-9 bg-slate-200 mx-auto rounded-full flex items-center"
              >
